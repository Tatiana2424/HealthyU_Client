  ...
  return (
    <div className="health-tip-container">
      ...
      <div className="health-tip-content">
        ...
        <p>
          Here's a helpful tip for a healthier lifestyle: Start your day with a
          glass of water and a 15-minute meditation or stretching routine. This
          helps to wake up your body, hydrate, and set a calm tone for the rest
          of the day.
        </p>
      </div>
    </div>
