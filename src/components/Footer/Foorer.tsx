          ...
          <div className="row">
            <div className="col-md-4">
              ...
              <p>
                ...
                health and wellness is ongoing and dynamic.
              </p>
            ...
            <div className="col-md-3">
              <h5>Contacts</h5>
              <p>
                <span className="contacts-field">Address:</span> 1010 3rd Ave,
                New York
              </p>
              <p>
                <span className="contacts-field">Phone:</span> +(380) 567 89 00
              </p>
              <p>
