...
const SignUpPage: React.FC = () => {
    ...
    const validateForm = () => {
        ...
        if (!userData.userName || !userData.firstName || !userData.lastName || !userData.email || !userData.password || !confirmPassword) {
    ...
    const handleSignUp = async (e: React.FormEvent) => {
        ...
        try {
            const response = await apiService.post<RegisterResponse>(
                'https://localhost:7271/api/auth/register',
                userData
            );
            console.log('Registration successful', response.token);
            console.log('Registration', response.userId);
