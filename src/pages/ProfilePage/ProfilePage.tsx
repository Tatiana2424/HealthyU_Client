...
const ProfilePage: React.FC = () => {
        ...
        const fetchUserData = async () => {
            if (userId) {
                ...
                if (response !== null) {
                    ...
                    setUserData(response); // Update state if we have valid data
                    ...
                    // Handle error or set default state as needed
                }
            }
            setLoading(false);
        };
    ...
    const handleSaveChanges = async (
        ...
        try {
            ...
            // Optionally, fetch user data again to reflect updates
        } catch (error) {
                                ...
                                <ul>
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            <path d="m11.75 1c-1.624 0-3.034.911-3.75 2.249-.716-1.338-2.126-2.249-3.75-2.249-2.347 0-4.25 1.903-4.25 4.25 0 5.75 8 9.75 8 9.75s8-4 8-9.75c0-2.347-1.903-4.25-4.25-4.25z" />
                                        </svg>
                                        Saved Recipes
                                    </li> */}
                                    <li
                                        onClick={() =>
                                            setActiveSection('addArticles')
                                        }
                                        className={
                        ...
                        <main className="main-content">
                            {activeSection === 'personalInfo' && (
                                <div className="profile-content">
                                    <h1>Personal Info</h1>
                                    <p>
                                        These details will be used for all the
                                        Meredith profiles associated...
                                    </p>
                                    <form
                                        onSubmit={(e) =>
                                            handleSaveChanges(e, 'personalInfo')
                                        }
                                    >
                            ...
                            {activeSection === 'publicProfileSettings' && (
                                <div className="public-profile-settings-section">
                                    ...
                                    <p>
                                        You have opted out of having a public
                                        profile, so the information on this page
                            ...
                            {activeSection === 'changePassword' && (
                                <div className="profile-content">
                                    ...
                                    <p>
                                        ...
                                        click the button below, and we will send
                                        password reset instructions to your
                                        email address.
                                    </p>
